<?php
	...
	if(!defined('ipbwi_BOARD_PATH')){
		define('ipbwi_BOARD_PATH','/Users/Petter/Dropbox/Web/Webapplikasjoner/ipb2/');
	}
	...
	if(!defined('ipbwi_ROOT_PATH')){
		define('ipbwi_ROOT_PATH','/Users/Petter/Dropbox/Web/Webapplikasjoner/GWZ/v2/ipbwi/');
	}

	/**
	 * The full qualified filesystem path to the upload folder of your IPBWI installation.
	 * You must add a trailing slash. This config-var is actually not used. It will be used
	 * when attachment uploading is integrated in IPBWI
	 *
	 * Example path: '/home/public_html/website/ipbwi/uplads/'
	 */
	if(!defined('ipbwi_UPLOAD_PATH')){
		define('ipbwi_UPLOAD_PATH','/Users/Petter/Dropbox/Web/Webapplikasjoner/GWZ/v2/ipbwi/uploads/');
	}
	...
	if(!defined('ipbwi_WEB_URL')){
		define('ipbwi_WEB_URL','http://localhost/Webapplikasjoner/GWZ/v2/');
	}
