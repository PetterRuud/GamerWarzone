...
function show() {
	...
	$send_to = "webmaster@gamerwarzone.com";
	
	// To send HTML mail, the Content-type header must be set
$headers  = 'MIME-Version: 1.0' . "\r\n";
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
// Additional headers
$headers .= 'From: GamerWarzone <webmaster@gamerwarzone.com>' . "\r\n";
...
$fullSubject = <<<EOF
GamerWarzone - {$subject}
EOF;
$fullMessage = <<<EOF
<html>
<head>
  <title>Email from Gamerwarzone</title>
</head>
<body>
  <p>This e-mail was sent using the contactform at http://gamerwarzone.com/index.php?act=contact</p>
  <table>
    <tr>
...
$html .= <<<EOF
		...
		<input class="required swap" type="text" id="name" name="name" value="Name" />
		<br /><span class="smalltext">Username used on forum:  <em>{$username}</em></span>
		
		<label for="email">E-mail</label>
		<input class="required swap" type="text" id="email" name="email" value="E-mail"/>
		<br /><span class="smalltext">E-mail used on forum:  <em>{$useremail}</em></span>
		
		<label for="subject">Subject</label>
		<input class="required swap" size="60" type="text" id="subject" name="subject" value="Subject" />
