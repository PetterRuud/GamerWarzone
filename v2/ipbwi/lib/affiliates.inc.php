...
<div class="article">
	...
	<p>			
		...
		<img src="{$ipbwi->getBoardVar('home_url')}/images/buttons/button.png" alt="GamerWarzone" />
				
		<div>
			<textarea cols="50" rows="3"><a href="http://gamerwarzone.com" title="GamerWarzone"><img src="http://GamerWarzone.com/images/buttons/button.png" alt="GamerWarzone" /></a></textarea>
		</div>
			
		<br />
		<b>468x60px banners</b><br />
		<img src="{$ipbwi->getBoardVar('home_url')}/images/buttons/igobt468x60.gif" alt="GamerWarzone" />
						
		<div>
			<textarea cols="50" rows="3"><a href="http://GamerWarzone.com" title="GamerWarzone"><img src="http://GamerWarzone.com/images/buttons/igobt468x60.gif" alt="GamerWarzone" /></a></textarea>
		</div>
		<br /><br />
	</p>
...
EOF;
		...
		$html .= <<<EOF
		<li>
				<a href="{$ipbwi->getBoardVar('home_url')}index.php?act=affiliates&amp;code=out&amp;id={$id}" target="_blank"><img src="{$button}" border="0" height="31px" width="88px" alt="{$url}"/></a>
		</li>
EOF;
		}
		$html .= <<<EOF
	</ul>
	<p><a href="{$ipbwi->getBoardVar('home_url')}index.php?act=affiliates&amp;code=view">View All</a></p>
EOF;
echo $html;
	}
